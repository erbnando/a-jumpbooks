...
function foundationpress_pagination() {
	...
	$paginate_links = paginate_links( array(
		...
		'mid_size' => 2,
		'prev_next' => true,
	    'prev_text' => __( '&lsaquo;', 'foundationpress' ),
	    'next_text' => __( '&rsaquo;', 'foundationpress' ),
		'type' => 'list',
	) );

	if (get_query_var('paged') > 1) {
		$paginate_links = str_replace( "<ul class='page-numbers'>", "<ul class='pagination'><li class='show'><a href=" . esc_url(get_pagenum_link(1)) . ">&laquo;</a></li>", $paginate_links );
	} else {
		$paginate_links = str_replace( "<ul class='page-numbers'>", "<ul class='pagination'>", $paginate_links );		
	}
	if (get_query_var('paged') < $wp_query->max_num_pages) {
		$paginate_links = str_replace( "</ul>", "<li class='show'><a href=" . esc_url(get_pagenum_link($wp_query->max_num_pages)) . ">&raquo;</a></li></ul>", $paginate_links );
	} 
	$paginate_links = str_replace( '<li><span class="page-numbers dots">', "<li><a href='#'>", $paginate_links );
	$paginate_links = str_replace( "<li><span class='page-numbers current'>", "<li class='current'><a href='#'>", $paginate_links );
	$paginate_links = str_replace( '</span>', '</a>', $paginate_links );
	$paginate_links = str_replace( "<li><a href='#'>&hellip;</a></li>", "<li><span class='dots'>&hellip;</span></li>", $paginate_links );
	$paginate_links = preg_replace( '/page-numbers/', '', $paginate_links );
	$paginate_links = preg_replace( '/<li><a class="next "/', '<li class="next"><a', $paginate_links );
	$paginate_links = preg_replace( '/<li><a class="prev "/', '<li class="prev"><a', $paginate_links );
