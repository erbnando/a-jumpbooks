	...
	public function init_form_fields() {
		...
		$form_fields = array(
			'location' => array(
				...
				'type'        => 'select',
				'description' => __( 'Select the location you wish to link to this site. Will be enabled if you have locations set in Square.', 'woocommerce-square' ),
				'desc_tip'    => false,
			...
			'sync_title' => array(
				...
				'type'        => 'title',
				'description' => __( 'Determine which aspects of your product catalog to synchronize between WooCommerce and Square. Products are matched on SKU initially and will be created if not found.', 'woocommerce-square' ),
			),
			'sync_products' => array(
